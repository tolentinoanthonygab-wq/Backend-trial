    ...
    <ErrorBoundary>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={["resident"]} />}>
          <Route path="/resident_dashboard" element={<StudentDashboard />} />
          <Route path="/resident_home" element={<HomeUser role="resident" />} />
          <Route
            path="/resident_upcoming_events"
            element={<UpcomingEvents role="resident" />}
          />
          <Route
            path="/resident_events_attended"
            element={<EventsAttended role="resident" />}
          />
          <Route path="/resident_profile" element={<Profile role="resident" />} />
        </Route>
