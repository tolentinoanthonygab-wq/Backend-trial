...
export const NavbarAdmin = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`admin-sidebar ${sidebarOpen ? "open" : ""} ${isExpanded ? "expanded" : "collapsed"
          }`}
      >
      ...
      {/* Main Content Area */}
      <div
        className={`admin-content ${sidebarOpen ? "shifted" : ""} ${isExpanded ? "content-expanded" : "content-collapsed"
          }`}
      ></div>
    </>
  );
