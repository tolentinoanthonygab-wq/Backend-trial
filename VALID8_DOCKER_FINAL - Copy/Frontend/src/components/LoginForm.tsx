  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (userData.roles.includes("admin")) {
        ...
        userData.roles.includes("official") &&
        userData.roles.includes("staff") &&
        userData.roles.includes("organizer")
      ) {
        navigate("/official_staff_organizer_dashboard");
      } else if (
        userData.roles.includes("official") &&
        userData.roles.includes("staff")
      ) {
        navigate("/official_staff_dashboard");
      } else if (userData.roles.includes("resident") || userData.roles.includes("official")) {
